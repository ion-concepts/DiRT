...
#
runSVUnit -s questa --c_arg "-incdir ../../global -incdir ../../axis -incdir ../../ethernet +libext+.sv -y ../../axis -y ../../dsp -y ../../ethernet -y /opt/Xilinx/Vivado/2022.2/data/verilog/src/unisims" \
