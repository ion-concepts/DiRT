...
#
runSVUnit -s questa --c_arg "-incdir ../../global -incdir ../../axis +libext+.sv -y ../../axis" \
          --r_arg "-permit_unmatched_virtual_intf" -f dependencies.f -o sim $UNIT
#runSVUnit -s questa --c_arg "-incdir ../../global -incdir ../../axis +libext+.sv -y ../../axis" \
#        --r_arg "-gui -voptargs=+acc=npr" -f dependencies.f -o sim $UNIT
#runSVUnit -s xsim -o sim --c_arg "-include ../../global -include ../../axis" \
#        --r_arg " work.testrunner --R " # "work.testrunner --R --gui"
